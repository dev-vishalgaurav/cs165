...
import com.varunmishra.debugthis.runtracker.RunDatabaseHelper.RunCursor;
...
public class RunManager {
    ...
    public LocationCursor queryLocations(long id) {
        return mHelper.queryLocations(id);
    }
    ...
    public void insertLocation(Location loc) {
        if (mCurrentRunId != -1) {
           long insertId =  mHelper.insertLocation(mCurrentRunId, loc);
            Log.e("VVV", "Location received run id = " + mCurrentRunId + " insert id = " + insertId);
        } else {
